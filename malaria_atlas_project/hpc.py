...
def get_cluster_kwargs(
    ...
    **kwargs
    ...
    cluster_kwargs["job_script_prologue"] = [f"cd {os.path.dirname(os.path.realpath(__file__))}"]
    #cluster_kwargs["job_script_prologue"] = [f"conda develop {os.path.dirname(os.path.realpath(__file__))}"]
